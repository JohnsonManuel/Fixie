...
function UserCardSkeleton() {
  return (
    <div className="bg-white rounded-xl p-5 flex flex-col gap-3" style={{ border: '1px solid #e4e4e7' }}>
    ...
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <div className="px-6 md:px-8 py-5 shrink-0 bg-white" style={{ borderBottom: '1px solid #e4e4e7' }}>
        <div className="flex items-center justify-between gap-4">
          <div>
            <h1 className="text-[17px] font-bold text-zinc-900">Team</h1>
      ...
      <div className="flex-1 overflow-y-auto p-6 md:p-8" style={{ background: '#fafafa' }}>
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 px-6 text-center fade-in">
            ...
            <h3 className="text-[15px] font-semibold text-zinc-700 mb-2">Your team is empty</h3>
            <p className="text-[13px] text-zinc-400 max-w-xs leading-relaxed mb-6">
          ...
          filteredUsers.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-16 text-center fade-in">
              <div className="w-10 h-10 rounded-full bg-zinc-100 flex items-center justify-center mb-3" aria-hidden="true">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#a1a1aa" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <circle cx="11" cy="11" r="8" /><line x1="21" y1="21" x2="16.65" y2="16.65" />
                </svg>
              </div>
              <p className="text-[13.5px] font-medium text-zinc-600 mb-1">No results for "{search}"</p>
              <p className="text-[12px] text-zinc-400">Try a different name, email, or domain.</p>
            </div>
          ) : (
                    ...
                    <div className="flex items-start justify-between gap-2">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="min-w-0">
                          ...
                          {/* Role badge */}
                          <span
                            className={`inline-block text-[10.5px] font-semibold px-1.5 py-px rounded-full mt-0.5 ${
                              u.is_admin
